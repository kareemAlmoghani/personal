                                    ...
                                    <div class="row align-items-center gx-5">
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                ...
                                                <div class="small fw-bolder">{{ $experience->title_trans }}</div>
                                                <div class="small text-muted">{{ $experience->company_trans }}</div>
                                                <div class="small text-muted">{{ $experience->location_trans }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8"><div>{{ $experience->content_trans }}</div></div>
                                    </div>
                                </div>
                            </div>
                           @endforeach
                                        ...
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="small text-muted">{{ $educatione->location_trans }}</div>
                                                </div>
                                                <div class="fst-italic">
                                                    <div class="small text-muted">{{ $educatione->degree_trans }}</div>
                                                    <div class="small text-muted">{{ $educatione->field_trans }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8"><div>{{ $educatione->content_trans }}</div></div>
                                    </div>
                                </div>
                            </div>
