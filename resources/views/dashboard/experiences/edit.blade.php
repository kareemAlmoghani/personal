                    ...
                    @csrf
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-4">
                         <div class="mt-4">
                            ...
                            <x-text-input id="title_en" class="block mt-1 w-full" type="text" name="title_en" :value="old('title_en',$experience->title['en'])" required   />
                            <x-input-error :messages="$errors->get('title_en')" class="mt-2" />
                         </div>
                          <div class="mt-4">
                            <x-input-label for="title_ar" :value="__('Arabic Title')" />
                            <x-text-input id="title_ar" class="block mt-1 w-full" type="text" name="title_ar" :value="old('title_ar',$experience->title['ar'])" required   />
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-4">
                         <div class="mt-4">
                            ...
                            <x-text-input id="start_date" class="block mt-1 w-full" type="text" name="start_date" :value="old('start_date',$experience->start_date)" required   />
                            <x-input-error :messages="$errors->get('start_date')" class="mt-2" />
                         </div>
                          <div class="mt-4">
                            <x-input-label for="end_date" :value="__('End Experience Date')" />
                            <x-text-input id="end_date" class="block mt-1 w-full" type="text" name="end_date" :value="old('end_date',$experience->end_date)" required   />
                         ...
                         <div class="mt-4">
                            ...
                            <x-text-input id="company_en" class="block mt-1 w-full" type="text" name="company_en" :value="old('company_en',$experience->company['en'])" required />
                            <x-input-error :messages="$errors->get('company_en')" class="mt-2" />
                         </div>
                          <div class="mt-4">
                            <x-input-label for="company_ar" :value="__('Arabic Company')" />
                            <x-text-input id="company_ar" class="block mt-1 w-full" type="text" name="company_ar" :value="old('company_ar',$experience->company['ar'])" required  />
                         ...
                         <div class="mt-4">
                            ...
                            <x-text-input id="location_en" class="block mt-1 w-full" type="text" name="location_en" :value="old('location_en',$experience->location['en'])"  />
                            <x-input-error :messages="$errors->get('location_en')" class="mt-2" />
                         </div>
                          <div class="mt-4">
                            <x-input-label for="location_ar" :value="__('Arabic location')" />
                            <x-text-input id="location_ar" class="block mt-1 w-full" type="text" name="location_ar" :value="old('location_ar',$experience->location['ar'])"   />
                         ...
                         <div class="mt-4">
                            ...
                            <x-text-textarea id="content_en" class="block mt-1 w-full" type="text" name="content_en" required >
                                {{ old('content_en',$experience->content['en']) }}
                            </x-text-textarea>
                          ...
                          <div class="mt-4">
                            ...
                            <x-text-textarea id="content_ar" class="block mt-1 w-full" type="text" name="content_ar" :value="old('content_ar')" required  >
                                {{ old('content_ar',$experience->content['ar']) }}
                            </x-text-textarea>
